      ...
      <>
        ...
        <section className="bg-white p-4 rounded-lg w-full">
          <div className="flex flex-col lg:flex-row items-center justify-between pb-[16px] lg:pb-[23px]">
            <h3>
              company {id} খতিয়ান তথ্যবলি ({en2bn(data?.length)})
            </h3>
            <div className="flex flex-col lg:flex-row space-y-1 lg:space-y-0 lg:space-x-4">
              ...
              <Link
                ...
                shallow
                className="flex items-center bg-[#A5008A] text-white text-12 leading-[12.14px] lg:text-14 lg:leading-[14.16px] rounded-md px-3 py-2 space-x-2"
              >
                <svg
                  width="13"
                  height="15"
                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-900 text-center">
                        <span className="leading-10 text-[15px] text-[#0E1F1C]">
                          <Link
                            href={{ pathname: "#" }}
                            shallow
                            className="inline-flex items-center space-x-1 text-secondary  hover:scale-125 transition-all duration-700"
                          >
                            <span>বিস্তারিত</span>
                            <span>
                              <svg
                              ...
                              >
                                <path
                                  d="M6.96 0.5L10.71 4.25V5.3L6.96 9.05L5.895 8L8.355 5.525H0V4.025H8.355L5.88 1.55L6.96 0.5Z"
                                  fill="#198754"
                                />
                              </svg>
                            </span>
